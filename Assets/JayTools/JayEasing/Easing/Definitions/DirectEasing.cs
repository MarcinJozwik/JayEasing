...
{
// Taken from https://gist.github.com/Fonserbc/3d31a25e87fdaa541ddf
    ...
    public class DirectEasing
    {
        ...
        public class Elastic
        {
            ...
            public static float Out(float k)
            {
                if (k == 0) return 0;
                if (k == 1) return 1;
                return Mathf.Pow(2f, -10f * k) * Mathf.Sin((k - 0.1f) * (2f * Mathf.PI) / 0.4f) +
                       1f;
            }
            ...
            {
                if ((k *= 2f) < 1f)
                    return -0.5f * Mathf.Pow(2f, 10f * (k -= 1f)) *
                           Mathf.Sin((k - 0.1f) * (2f * Mathf.PI) / 0.4f);
                return Mathf.Pow(2f, -10f * (k -= 1f)) *
                    Mathf.Sin((k - 0.1f) * (2f * Mathf.PI) / 0.4f) * 0.5f + 1f;
            }
        };
